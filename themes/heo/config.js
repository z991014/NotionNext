const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.686898.xyz' },
    { title: 'Thank you to come my blog', url: 'https://blog.686898.xyz' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'BLOG.686898.XYZ',
  HERO_TITLE_LINK: 'https://blog.686898.xyz',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/tag/must' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/hot' },
  HERO_CATEGORY_3: { title: '实用教程', url: '/tag/useful' },
  ...
  INFO_CARD_URL: 'https://github.com/z991014', // 个人资料底部按钮链接
